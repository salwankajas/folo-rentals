...
export default function Hero() {
  return (
    <section className="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white overflow-hidden">
      <div className="container mx-auto px-4 py-60 relative">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between space-y-12 md:space-y-0 md:space-x-12">
          <div className="md:w-1/2 space-y-8">
            <span className="inline-block py-1 px-3 bg-pink-500 bg-opacity-30 rounded-full text-pink-300 text-sm font-semibold backdrop-filter backdrop-blur-sm">
            ...
            <div className="flex space-x-4">
              <a href="#0" className="px-6 py-3 bg-white text-indigo-900 rounded-full font-semibold hover:bg-opacity-90 transition duration-300">
                Start Riding
              </a>
              <a href="#0" className="px-6 py-3 border border-white text-white rounded-full font-semibold hover:bg-white hover:text-indigo-900 transition duration-300">
                View Bikes
              </a>
            </div>
          </div>
